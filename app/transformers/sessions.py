"""
app/transformers/sessions.py
=============================
Non-emitting transformer for fct_user_sessions.

fct_user_sessions is a FEATURE_SOURCE — it feeds the behaviour model
feature pipeline only. It does not emit graph records.
"""
...
class SessionsTransformer(BaseTransformer):
